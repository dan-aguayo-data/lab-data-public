...
SELECT DISTINCT
    ...
    d1.c2                               AS ENTITY_DESC,
    d1.c3                               AS ENTITY_L1_CODE,
    d1.c4                               AS ENTITY_L1_DESC,
    d1.c5                               AS ENTITY_L2_CODE,
    d1.c6                               AS ENTITY_L2_DESC,
    d1.c7                               AS ENTITY_L3_CODE,
    d1.c8                               AS ENTITY_L3_DESC,
    d1.c9                               AS ENTITY_L4_CODE,
    d1.c10                              AS ENTITY_L4_DESC,
    d1.c11                              AS ENTITY_L5_CODE,
    d1.c12                              AS ENTITY_L5_DESC,
    d1.c13                              AS ENTITY_L6_CODE,
    d1.c14                              AS ENTITY_L6_DESC,
    d1.c15                              AS ENTITY_L7_CODE,
    d1.c16                              AS ENTITY_L7_DESC,
    d1.c17                              AS ENTITY_L8_CODE,
    d1.c18                              AS ENTITY_L8_DESC,
    d1.c19                              AS ENTITY_L9_CODE,
    d1.c20                              AS ENTITY_L9_DESC,
    d1.c21                              AS ENTITY_L10_CODE,
    d1.c22                              AS ENTITY_L10_DESC,
    d1.c61                              AS ENTITY_L30_CODE,
    d1.c62                              AS ENTITY_L30_DESC,
    d1.c63                              AS ENTITY_L31_CODE,
    d1.c64                              AS ENTITY_L31_DESC,
    concat(concat(d1.c66, '-'), d1.c67) AS ENTITY_TREE_CODE
FROM
    sawith0 d1
WHERE d1.c67 IS NOT NULL
ORDER BY ENTITY_CODE, ENTITY_TREE_CODE
