            ...
            FROM
                (
                    ...
                    WHERE
                          ...
                          AND cft.TREE_CODE  LIKE ANY ('Cost Center%','CC%')
                          /*
                ...
                (
                    ...
                    WHERE
                        ...
                        AND fndtree.TREE_CODE LIKE ANY ('Cost Center%','CC%')
                        /*
                        IN (  
                             'Account Scheme Ledger'
                            ,'Account Scheme TAS Ledger'
...
SELECT DISTINCT
    d1.c1                               AS COST_CENTER_CODE,
    d1.c2                               AS COST_CENTER_DESC,
    d1.c3                               AS COST_CENTER_L1_CODE,
    d1.c4                               AS COST_CENTER_L1_DESC,
    d1.c5                               AS COST_CENTER_L2_CODE,
    d1.c6                               AS COST_CENTER_L2_DESC,
    d1.c7                               AS COST_CENTER_L3_CODE,
    d1.c8                               AS COST_CENTER_L3_DESC,
    d1.c9                               AS COST_CENTER_L4_CODE,
    d1.c10                              AS COST_CENTER_L4_DESC,
    d1.c11                              AS COST_CENTER_L5_CODE,
    d1.c12                              AS COST_CENTER_L5_DESC,
    d1.c13                              AS COST_CENTER_L6_CODE,
    d1.c14                              AS COST_CENTER_L6_DESC,
    d1.c15                              AS COST_CENTER_L7_CODE,
    d1.c16                              AS COST_CENTER_L7_DESC,
    d1.c17                              AS COST_CENTER_L8_CODE,
    d1.c18                              AS COST_CENTER_L8_DESC,
    d1.c19                              AS COST_CENTER_L9_CODE,
    d1.c20                              AS COST_CENTER_L9_DESC,
    d1.c21                              AS COST_CENTER_L10_CODE,
    d1.c22                              AS COST_CENTER_L10_DESC,
    d1.c61                              AS COST_CENTER_L30_CODE,
    d1.c62                              AS COST_CENTER_L30_DESC,
    d1.c63                              AS COST_CENTER_L31_CODE,
    d1.c64                              AS COST_CENTER_L31_DESC,
    concat(concat(d1.c66, '-'), d1.c67) AS COST_CENTER_TREE_CODE
FROM
    sawith0 d1
WHERE d1.c67 IS NOT NULL 
ORDER BY COST_CENTER_CODE, COST_CENTER_TREE_CODE
