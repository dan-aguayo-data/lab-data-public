            ...
            FROM
                ...
                (
                    ...
                    WHERE
                        ...
                        AND fndtree.TREE_CODE LIKE 'Spare%'
                        /*
                        IN (  
                             'Account Scheme Ledger'
                            ,'Account Scheme TAS Ledger'
...
SELECT DISTINCT
    d1.c1                               AS PROJECT_CODE,
    d1.c2                               AS PROJECT_DESC,
    d1.c3                               AS PROJECT_L1_CODE,
    d1.c4                               AS PROJECT_L1_DESC,
    d1.c5                               AS PROJECT_L2_CODE,
    d1.c6                               AS PROJECT_L2_DESC,
    d1.c7                               AS PROJECT_L3_CODE,
    d1.c8                               AS PROJECT_L3_DESC,
    d1.c9                               AS PROJECT_L4_CODE,
    d1.c10                              AS PROJECT_L4_DESC,
    d1.c11                              AS PROJECT_L5_CODE,
    d1.c12                              AS PROJECT_L5_DESC,
    d1.c13                              AS PROJECT_L6_CODE,
    d1.c14                              AS PROJECT_L6_DESC,
    d1.c15                              AS PROJECT_L7_CODE,
    d1.c16                              AS PROJECT_L7_DESC,
    d1.c17                              AS PROJECT_L8_CODE,
    d1.c18                              AS PROJECT_L8_DESC,
    d1.c19                              AS PROJECT_L9_CODE,
    d1.c20                              AS PROJECT_L9_DESC,
    d1.c21                              AS PROJECT_L10_CODE,
    d1.c22                              AS PROJECT_L10_DESC,
    d1.c61                              AS PROJECT_L30_CODE,
    d1.c62                              AS PROJECT_L30_DESC,
    d1.c63                              AS PROJECT_L31_CODE,
    d1.c64                              AS PROJECT_L31_DESC,
    concat(concat(d1.c66, '-'), d1.c67) AS PROJECT_TREE_CODE
FROM
    sawith0 d1
WHERE d1.c67 IS NOT NULL 
ORDER BY PROJECT_CODE, PROJECT_TREE_CODE
