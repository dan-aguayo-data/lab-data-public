            ...
            FROM
                (
                    ...
                    WHERE
                          ...
                          AND cft.TREE_CODE like 'Account%'
                          /*
                ...
                (
                    ...
                    WHERE
                        ...
                        AND fndtree.TREE_CODE like 'Account%'
                        /*
                        IN (  
                             'Account Scheme Ledger'
                            ,'Account Scheme TAS Ledger'
...
SELECT DISTINCT
    d1.c1                               AS ACCOUNT_CODE,
    d1.c2                               AS ACCOUNT_DESC,
    d1.c3                               AS ACCOUNT_L1_CODE,
    d1.c4                               AS ACCOUNT_L1_DESC,
    d1.c5                               AS ACCOUNT_L2_CODE,
    d1.c6                               AS ACCOUNT_L2_DESC,
    d1.c7                               AS ACCOUNT_L3_CODE,
    d1.c8                               AS ACCOUNT_L3_DESC,
    d1.c9                               AS ACCOUNT_L4_CODE,
    d1.c10                              AS ACCOUNT_L4_DESC,
    d1.c11                              AS ACCOUNT_L5_CODE,
    d1.c12                              AS ACCOUNT_L5_DESC,
    d1.c13                              AS ACCOUNT_L6_CODE,
    d1.c14                              AS ACCOUNT_L6_DESC,
    d1.c15                              AS ACCOUNT_L7_CODE,
    d1.c16                              AS ACCOUNT_L7_DESC,
    d1.c17                              AS ACCOUNT_L8_CODE,
    d1.c18                              AS ACCOUNT_L8_DESC,
    d1.c19                              AS ACCOUNT_L9_CODE,
    d1.c20                              AS ACCOUNT_L9_DESC,
    d1.c21                              AS ACCOUNT_L10_CODE,
    d1.c22                              AS ACCOUNT_L10_DESC,
    d1.c61                              AS ACCOUNT_L30_CODE,
    d1.c62                              AS ACCOUNT_L30_DESC,
    d1.c63                              AS ACCOUNT_L31_CODE,
    d1.c64                              AS ACCOUNT_L31_DESC,
    concat(concat(d1.c66, '-'), d1.c67) AS ACCOUNT_TREE_CODE
FROM
    sawith0 d1
WHERE d1.c67 IS NOT NULL
ORDER BY ACCOUNT_CODE, ACCOUNT_TREE_CODE
