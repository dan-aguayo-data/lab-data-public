            ...
            FROM
                (
                    ...
                    WHERE
                          ...
                          AND cft.TREE_CODE LIKE 'Company%'
                          /*
                ...
                (
                    ...
                    WHERE
                        ...
                        AND fndtree.TREE_CODE LIKE 'Company%'
                        /*
                        IN (  
                             'Account Scheme Ledger'
                            ,'Account Scheme TAS Ledger'
...
SELECT DISTINCT
    d1.c1                               AS INTERCOMPANY_CODE,
    d1.c2                               AS INTERCOMPANY_DESC,
    d1.c3                               AS INTERCOMPANY_L1_CODE,
    d1.c4                               AS INTERCOMPANY_L1_DESC,
    d1.c5                               AS INTERCOMPANY_L2_CODE,
    d1.c6                               AS INTERCOMPANY_L2_DESC,
    d1.c7                               AS INTERCOMPANY_L3_CODE,
    d1.c8                               AS INTERCOMPANY_L3_DESC,
    d1.c9                               AS INTERCOMPANY_L4_CODE,
    d1.c10                              AS INTERCOMPANY_L4_DESC,
    d1.c11                              AS INTERCOMPANY_L5_CODE,
    d1.c12                              AS INTERCOMPANY_L5_DESC,
    d1.c13                              AS INTERCOMPANY_L6_CODE,
    d1.c14                              AS INTERCOMPANY_L6_DESC,
    d1.c15                              AS INTERCOMPANY_L7_CODE,
    d1.c16                              AS INTERCOMPANY_L7_DESC,
    d1.c17                              AS INTERCOMPANY_L8_CODE,
    d1.c18                              AS INTERCOMPANY_L8_DESC,
    d1.c19                              AS INTERCOMPANY_L9_CODE,
    d1.c20                              AS INTERCOMPANY_L9_DESC,
    d1.c21                              AS INTERCOMPANY_L10_CODE,
    d1.c22                              AS INTERCOMPANY_L10_DESC,
    d1.c61                              AS INTERCOMPANY_L30_CODE,
    d1.c62                              AS INTERCOMPANY_L30_DESC,
    d1.c63                              AS INTERCOMPANY_L31_CODE,
    d1.c64                              AS INTERCOMPANY_L31_DESC,
    concat(concat(d1.c66, '-'), d1.c67) AS INTERCOMPANY_TREE_CODE
FROM
    sawith0 d1
WHERE d1.c67 IS NOT NULL 
ORDER BY INTERCOMPANY_CODE, INTERCOMPANY_TREE_CODE
