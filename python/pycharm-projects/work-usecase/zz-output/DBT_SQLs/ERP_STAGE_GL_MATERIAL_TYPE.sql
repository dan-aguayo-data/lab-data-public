            ...
            FROM
                (
                    ...
                    WHERE
                          ...
                          AND cft.TREE_CODE LIKE 'Mat Type%'
                          /*
                ...
                (
                    ...
                    WHERE
                        ...
                        AND fndtree.TREE_CODE LIKE 'Mat Type%'
                        /*
                        IN (  
                             'Account Scheme Ledger'
                            ,'Account Scheme TAS Ledger'
...
SELECT DISTINCT
    d1.c1                               AS MAT_TYPE_CODE,
    d1.c2                               AS MAT_TYPE_DESC,
    d1.c3                               AS MAT_TYPE_L1_CODE,
    d1.c4                               AS MAT_TYPE_L1_DESC,
    d1.c5                               AS MAT_TYPE_L2_CODE,
    d1.c6                               AS MAT_TYPE_L2_DESC,
    d1.c7                               AS MAT_TYPE_L3_CODE,
    d1.c8                               AS MAT_TYPE_L3_DESC,
    d1.c9                               AS MAT_TYPE_L4_CODE,
    d1.c10                              AS MAT_TYPE_L4_DESC,
    d1.c11                              AS MAT_TYPE_L5_CODE,
    d1.c12                              AS MAT_TYPE_L5_DESC,
    d1.c13                              AS MAT_TYPE_L6_CODE,
    d1.c14                              AS MAT_TYPE_L6_DESC,
    d1.c15                              AS MAT_TYPE_L7_CODE,
    d1.c16                              AS MAT_TYPE_L7_DESC,
    d1.c17                              AS MAT_TYPE_L8_CODE,
    d1.c18                              AS MAT_TYPE_L8_DESC,
    d1.c19                              AS MAT_TYPE_L9_CODE,
    d1.c20                              AS MAT_TYPE_L9_DESC,
    d1.c21                              AS MAT_TYPE_L10_CODE,
    d1.c22                              AS MAT_TYPE_L10_DESC,
    d1.c61                              AS MAT_TYPE_L30_CODE,
    d1.c62                              AS MAT_TYPE_L30_DESC,
    d1.c63                              AS MAT_TYPE_L31_CODE,
    d1.c64                              AS MAT_TYPE_L31_DESC,
    concat(concat(d1.c66, '-'), d1.c67) AS MAT_TYPE_TREE_CODE
FROM
    sawith0 d1
WHERE d1.c67 IS NOT NULL 
ORDER BY MAT_TYPE_CODE, MAT_TYPE_TREE_CODE