...
# A class is like a Blueprint which can be used to create an object.
# You can assign the class to an object and then use the attributes on that same object to specify details.
#TODO 1. This is how to put TODO in a code.
...
#
# Key learning
# Create objects from classes, and then use their attributes on that specific pre-defined object.
# Once you are using this object you can access methods and attributes.
# Attributes are just variables so we can just change their value as desired.
# Methods are like functions that you can use e.g. add columns.
