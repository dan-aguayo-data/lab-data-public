...
SETP 2. AWS - CREATE ROLE AS AWS ACCOUNT AND ATTACH POLIVY. 
Notes: 
...
CREATE STORAGE INTEGRATION JSON_TEST
  ...
  STORAGE_PROVIDER = 'S3'
  ENABLED = TRUE
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::398662845025:role/Snowpipe_Test_AWS_SF_Role_dan'
  STORAGE_ALLOWED_LOCATIONS = ('*')
  --[ STORAGE_BLOCKED_LOCATIONS = ('s3://mybucket1/mypath1/sensitivedata/', 's3://mybucket2/mypath2/sensitivedata/') ]
;


--DROP STORAGE INTEGRATION SON_TEST ;
...
arn:aws:iam::891377375664:user/2mtj0000-s
--External ID
...
create table LANDING_S3.SNOWPIPE_TABLES.MY_S3_TEST_RAW (
...
auto_ingest=true 
as
copy into LANDING_S3.SNOWPIPE_TABLES.MY_S3_TEST_RAW
...
--STEP 9. sf get the notification integration arn from pipe. 
...
SELECT *  FROM LANDING_S3.SNOWPIPE_TABLES.MY_S3_TEST_RAW
