...
from COMMON_PROD.ERP.AP_TRANSACTIONS

where id = '9517-23-1400-14920-0000-00000-300000170616134-1-5'
;
...
SUPPLIER_LATEST_DATE,
INCREMENTAL_LATEST_DATE
from RAW_PROD.CES_ERP.AP_TRANSACTIONS  where id = '9506-11-1400-14920-0000-00000-300000170407908-1-1'
...
select count(*) from RAW_PROD.CES_ERP.AP_TRANSACTIONS  
 WHERE DATE(INVOICE_DATE) >= '2023-01-01'--AND DATE(INVOICE_DATE) <= '2023-12-31'

--23589553
;

select count(*)    FROM RAW_DEV.TEST.AP_TRANSACTIONS_TEST
        WHERE DATE(INVOICE_DATE) >= '2023-01-01' --AND DATE(INVOICE_DATE) <= '2023-12-31'

--23589532
;

--primary key CONCAT(CONCATENATED_SEGMENTS,'-', INVOICE_ID,'-', LINE_NUMBER,'-', DISTRIBUTION_LINE_NUM) AS ID

SELECT	TOP 1000
CONCAT(CONCATENATED_SEGMENTS,'-', INVOICE_ID,'-', LINE_NUMBER,'-', DISTRIBUTION_LINE_NUM) AS ID,
CONCATENATED_SEGMENTS,
ENTITY_CODE,
COST_CENTER_CODE,
ACCOUNT_CODE,
...
FROM RAW_PROD.CES_ERP.AP_TRANSACTIONS
WHERE DATE(INVOICE_DATE) = '2023-01-01'
 order by CONCAT(CONCATENATED_SEGMENTS,'-', INVOICE_ID,'-', LINE_NUMBER,'-', DISTRIBUTION_LINE_NUM)
...
FROM RAW_DEV.TEST.AP_TRANSACTIONS_TEST
WHERE DATE(INVOICE_DATE) = '2023-01-01'
 order by CONCAT(CONCATENATED_SEGMENTS,'-', INVOICE_ID,'-', LINE_NUMBER,'-', DISTRIBUTION_LINE_NUM)


;
CREATE TEMPORARY TABLE RAW_DEV.TEST.AP_TRANSACTIONS_TEST AS 
WITH 
...
GREATEST(invoiceheader.AP_INVOICES_LAST_UPDATE_DATE,invoicedistribution.AP_INVOICE_DISTRIBUTIONS_LAST_UPDATE_DATE,supplier.SUPPLIER_LAST_UPDATE_DATE) AS      INCREMENTAL_LATEST_DATE,
NVL(GREATEST(invoiceheader.AP_INVOICES_LAST_UPDATE_DATE,invoicedistribution.AP_INVOICE_DISTRIBUTIONS_LAST_UPDATE_DATE,supplier.SUPPLIER_LAST_UPDATE_DATE),current_date) AS NVL_TEST,
...
WITH combined AS (
    SELECT 
        ...
        t1.IDENTIFYING_PO AS t1_IDENTIFYING_PO,
        t2.IDENTIFYING_PO AS t2_IDENTIFYING_PO,
        t1.INVOICE_DATE AS t1_INVOICE_DATE,
        t2.INVOICE_DATE AS t2_INVOICE_DATE,
        t1.INVOICE_ID AS t1_INVOICE_ID,
        t2.INVOICE_ID AS t2_INVOICE_ID,
        t1.INVOICE_NUM AS t1_INVOICE_NUM,
        t2.INVOICE_NUM AS t2_INVOICE_NUM,
        t1.INVOICE_TYPE_CODE AS t1_INVOICE_TYPE_CODE,
        t2.INVOICE_TYPE_CODE AS t2_INVOICE_TYPE_CODE,
        t1.INVOICE_TYPE_NAME AS t1_INVOICE_TYPE_NAME,
        t2.INVOICE_TYPE_NAME AS t2_INVOICE_TYPE_NAME,
        t1.INVOICES_DATE_LAST_UPDATED AS t1_INVOICES_DATE_LAST_UPDATED,
        t2.INVOICES_DATE_LAST_UPDATED AS t2_INVOICES_DATE_LAST_UPDATED,
        t1.INVOICES_REVISION_DATE AS t1_INVOICES_REVISION_DATE,
        t2.INVOICES_REVISION_DATE AS t2_INVOICES_REVISION_DATE,
        t1.INVOICES_REVISION_NUMBER AS t1_INVOICES_REVISION_NUMBER,
        t2.INVOICES_REVISION_NUMBER AS t2_INVOICES_REVISION_NUMBER,
        t1.INVOICES_WITHHELD_TAX_AMOUNT AS t1_INVOICES_WITHHELD_TAX_AMOUNT,
        t2.INVOICES_WITHHELD_TAX_AMOUNT AS t2_INVOICES_WITHHELD_TAX_AMOUNT,
        t1.TERMS_DATE AS t1_TERMS_DATE,
        t2.TERMS_DATE AS t2_TERMS_DATE,
        t1.INV_DIST_ACCOUNTING_DATE AS t1_INV_DIST_ACCOUNTING_DATE,
        t2.INV_DIST_ACCOUNTING_DATE AS t2_INV_DIST_ACCOUNTING_DATE,
        t1.DISTRIBUTION_DESC AS t1_DISTRIBUTION_DESC,
        t2.DISTRIBUTION_DESC AS t2_DISTRIBUTION_DESC,
        t1.DISTRIBUTION_LINE_NUM AS t1_DISTRIBUTION_LINE_NUM,
        t2.DISTRIBUTION_LINE_NUM AS t2_DISTRIBUTION_LINE_NUM,
        t1.DISTRIBUTION_UNIT_PRICE AS t1_DISTRIBUTION_UNIT_PRICE,
        t2.DISTRIBUTION_UNIT_PRICE AS t2_DISTRIBUTION_UNIT_PRICE,
        t1.INV_DIST_POSTING_STATUS AS t1_INV_DIST_POSTING_STATUS,
        t2.INV_DIST_POSTING_STATUS AS t2_INV_DIST_POSTING_STATUS,
        t1.INV_DIST_REVERSAL_STATUS AS t1_INV_DIST_REVERSAL_STATUS,
        t2.INV_DIST_REVERSAL_STATUS AS t2_INV_DIST_REVERSAL_STATUS,
        t1.MATCH_STATUS AS t1_MATCH_STATUS,
        t2.MATCH_STATUS AS t2_MATCH_STATUS,
        t1.INVOICE_CURRENCY AS t1_INVOICE_CURRENCY,
        t2.INVOICE_CURRENCY AS t2_INVOICE_CURRENCY,
        t1.INV_LINE_LAST_UPDATE_DATE AS t1_INV_LINE_LAST_UPDATE_DATE,
        t2.INV_LINE_LAST_UPDATE_DATE AS t2_INV_LINE_LAST_UPDATE_DATE,
        t1.LINE_NUMBER AS t1_LINE_NUMBER,
        t2.LINE_NUMBER AS t2_LINE_NUMBER,
        t1.MATCH_TYPE AS t1_MATCH_TYPE,
        t2.MATCH_TYPE AS t2_MATCH_TYPE,
        t1.QUANTITY_INVOICED AS t1_QUANTITY_INVOICED,
        t2.QUANTITY_INVOICED AS t2_QUANTITY_INVOICED,
        t1.UNIT_PRICE AS t1_UNIT_PRICE,
        t2.UNIT_PRICE AS t2_UNIT_PRICE,
        t1.BUSINESS_UNIT_NAME AS t1_BUSINESS_UNIT_NAME,
        t2.BUSINESS_UNIT_NAME AS t2_BUSINESS_UNIT_NAME,
        ...
        t1.SUPPLIER_SITE_CODE AS t1_SUPPLIER_SITE_CODE,
        t2.SUPPLIER_SITE_CODE AS t2_SUPPLIER_SITE_CODE,
        t1.SUPPLIER_NUMBER AS t1_SUPPLIER_NUMBER,
        t2.SUPPLIER_NUMBER AS t2_SUPPLIER_NUMBER,
        t1.MATCH_STATUS_CODE AS t1_MATCH_STATUS_CODE,
        t2.MATCH_STATUS_CODE AS t2_MATCH_STATUS_CODE,
        t1.MATCH_TYPE_CODE AS t1_MATCH_TYPE_CODE,
        t2.MATCH_TYPE_CODE AS t2_MATCH_TYPE_CODE,
        t1.INVOICE_AMOUNT AS t1_INVOICE_AMOUNT,
        t2.INVOICE_AMOUNT AS t2_INVOICE_AMOUNT,
        t1.TOTAL_DISTRIBUTION_AMOUNT AS t1_TOTAL_DISTRIBUTION_AMOUNT,
        t2.TOTAL_DISTRIBUTION_AMOUNT AS t2_TOTAL_DISTRIBUTION_AMOUNT,
        t1.SUPPLIER_NAME AS t1_SUPPLIER_NAME,
        t2.SUPPLIER_NAME AS t2_SUPPLIER_NAME,
        t1.INVOICE_SOURCE_NAME AS t1_INVOICE_SOURCE_NAME,
        t2.INVOICE_SOURCE_NAME AS t2_INVOICE_SOURCE_NAME,
        t1.PAY_GROUP AS t1_PAY_GROUP,
        t2.PAY_GROUP AS t2_PAY_GROUP,
        t1.ACCOUNTING_DATE AS t1_ACCOUNTING_DATE,
        t2.ACCOUNTING_DATE AS t2_ACCOUNTING_DATE,
        t1.INVOICE_DESC AS t1_INVOICE_DESC,
        t2.INVOICE_DESC AS t2_INVOICE_DESC,
        t1.PAYMENT_TERMS AS t1_PAYMENT_TERMS,
        t2.PAYMENT_TERMS AS t2_PAYMENT_TERMS,
        t1.INV_CREATION_DATE AS t1_INV_CREATION_DATE,
        t2.INV_CREATION_DATE AS t2_INV_CREATION_DATE,
        t1.AP_INVOICES_LAST_UPDATE_DATE AS t1_AP_INVOICES_LAST_UPDATE_DATE,
        t2.AP_INVOICES_LAST_UPDATE_DATE AS t2_AP_INVOICES_LAST_UPDATE_DATE,
        t1.INV_DIST_LAST_UPDATE_DATE AS t1_INV_DIST_LAST_UPDATE_DATE,
        t2.INV_DIST_LAST_UPDATE_DATE AS t2_INV_DIST_LAST_UPDATE_DATE,
        t1.SUPPLIER_LATEST_DATE AS t1_SUPPLIER_LATEST_DATE,
        t2.SUPPLIER_LATEST_DATE AS t2_SUPPLIER_LATEST_DATE,
        t1.INCREMENTAL_LATEST_DATE AS t1_INCREMENTAL_LATEST_DATE,
        t2.INCREMENTAL_LATEST_DATE AS t2_INCREMENTAL_LATEST_DATE
    FROM (
        SELECT 
            CONCAT(CONCATENATED_SEGMENTS,'-', INVOICE_ID,'-', LINE_NUMBER,'-', DISTRIBUTION_LINE_NUM) AS ID,
            CONCATENATED_SEGMENTS,
...
SELECT 
    ID,
    CASE 
        WHEN t1_ID IS NOT NULL AND t2_ID IS NULL THEN 'Present in RAW_PROD.CES_ERP.AP_TRANSACTIONS only'
        WHEN t1_ID IS NULL AND t2_ID IS NOT NULL THEN 'Present in RAW_DEV.TEST.AP_TRANSACTIONS_TEST only'
    ...
    COALESCE(t1_IDENTIFYING_PO, t2_IDENTIFYING_PO) AS IDENTIFYING_PO,
    COALESCE(t1_INVOICE_DATE, t2_INVOICE_DATE) AS INVOICE_DATE,
    COALESCE(t1_INVOICE_ID, t2_INVOICE_ID) AS INVOICE_ID,
    COALESCE(t1_INVOICE_NUM, t2_INVOICE_NUM) AS INVOICE_NUM,
    COALESCE(t1_INVOICE_TYPE_CODE, t2_INVOICE_TYPE_CODE) AS INVOICE_TYPE_CODE,
    COALESCE(t1_INVOICE_TYPE_NAME, t2_INVOICE_TYPE_NAME) AS INVOICE_TYPE_NAME,
    COALESCE(t1_INVOICES_DATE_LAST_UPDATED, t2_INVOICES_DATE_LAST_UPDATED) AS INVOICES_DATE_LAST_UPDATED,
    COALESCE(t1_INVOICES_REVISION_DATE, t2_INVOICES_REVISION_DATE) AS INVOICES_REVISION_DATE,
    COALESCE(t1_INVOICES_REVISION_NUMBER, t2_INVOICES_REVISION_NUMBER) AS INVOICES_REVISION_NUMBER,
    COALESCE(t1_INVOICES_WITHHELD_TAX_AMOUNT, t2_INVOICES_WITHHELD_TAX_AMOUNT) AS INVOICES_WITHHELD_TAX_AMOUNT,
    COALESCE(t1_TERMS_DATE, t2_TERMS_DATE) AS TERMS_DATE,
    COALESCE(t1_INV_DIST_ACCOUNTING_DATE, t2_INV_DIST_ACCOUNTING_DATE) AS INV_DIST_ACCOUNTING_DATE,
    COALESCE(t1_DISTRIBUTION_DESC, t2_DISTRIBUTION_DESC) AS DISTRIBUTION_DESC,
    COALESCE(t1_DISTRIBUTION_LINE_NUM, t2_DISTRIBUTION_LINE_NUM) AS DISTRIBUTION_LINE_NUM,
    COALESCE(t1_DISTRIBUTION_UNIT_PRICE, t2_DISTRIBUTION_UNIT_PRICE) AS DISTRIBUTION_UNIT_PRICE,
    COALESCE(t1_INV_DIST_POSTING_STATUS, t2_INV_DIST_POSTING_STATUS) AS INV_DIST_POSTING_STATUS,
    COALESCE(t1_INV_DIST_REVERSAL_STATUS, t2_INV_DIST_REVERSAL_STATUS) AS INV_DIST_REVERSAL_STATUS,
    COALESCE(t1_MATCH_STATUS, t2_MATCH_STATUS) AS MATCH_STATUS,
    COALESCE(t1_INVOICE_CURRENCY, t2_INVOICE_CURRENCY) AS INVOICE_CURRENCY,
    COALESCE(t1_INV_LINE_LAST_UPDATE_DATE, t2_INV_LINE_LAST_UPDATE_DATE) AS INV_LINE_LAST_UPDATE_DATE,
    COALESCE(t1_LINE_NUMBER, t2_LINE_NUMBER) AS LINE_NUMBER,
    COALESCE(t1_MATCH_TYPE, t2_MATCH_TYPE) AS MATCH_TYPE,
    COALESCE(t1_QUANTITY_INVOICED, t2_QUANTITY_INVOICED) AS QUANTITY_INVOICED,
    COALESCE(t1_UNIT_PRICE, t2_UNIT_PRICE) AS UNIT_PRICE,
    COALESCE(t1_BUSINESS_UNIT_NAME, t2_BUSINESS_UNIT_NAME) AS BUSINESS_UNIT_NAME,
    ...
    COALESCE(t1_SUPPLIER_SITE_CODE, t2_SUPPLIER_SITE_CODE) AS SUPPLIER_SITE_CODE,
    COALESCE(t1_SUPPLIER_NUMBER, t2_SUPPLIER_NUMBER) AS SUPPLIER_NUMBER,
    COALESCE(t1_MATCH_STATUS_CODE, t2_MATCH_STATUS_CODE) AS MATCH_STATUS_CODE,
    COALESCE(t1_MATCH_TYPE_CODE, t2_MATCH_TYPE_CODE) AS MATCH_TYPE_CODE,
    COALESCE(t1_INVOICE_AMOUNT, t2_INVOICE_AMOUNT) AS INVOICE_AMOUNT,
    COALESCE(t1_TOTAL_DISTRIBUTION_AMOUNT, t2_TOTAL_DISTRIBUTION_AMOUNT) AS TOTAL_DISTRIBUTION_AMOUNT,
    COALESCE(t1_SUPPLIER_NAME, t2_SUPPLIER_NAME) AS SUPPLIER_NAME,
    COALESCE(t1_INVOICE_SOURCE_NAME, t2_INVOICE_SOURCE_NAME) AS INVOICE_SOURCE_NAME,
    COALESCE(t1_PAY_GROUP, t2_PAY_GROUP) AS PAY_GROUP,
    COALESCE(t1_ACCOUNTING_DATE, t2_ACCOUNTING_DATE) AS ACCOUNTING_DATE,
    COALESCE(t1_INVOICE_DESC, t2_INVOICE_DESC) AS INVOICE_DESC,
    COALESCE(t1_PAYMENT_TERMS, t2_PAYMENT_TERMS) AS PAYMENT_TERMS,
    COALESCE(t1_INV_CREATION_DATE, t2_INV_CREATION_DATE) AS INV_CREATION_DATE,
    COALESCE(t1_AP_INVOICES_LAST_UPDATE_DATE, t2_AP_INVOICES_LAST_UPDATE_DATE) AS AP_INVOICES_LAST_UPDATE_DATE,
    COALESCE(t1_INV_DIST_LAST_UPDATE_DATE, t2_INV_DIST_LAST_UPDATE_DATE) AS INV_DIST_LAST_UPDATE_DATE,
    COALESCE(t1_SUPPLIER_LATEST_DATE, t2_SUPPLIER_LATEST_DATE) AS SUPPLIER_LATEST_DATE,
    COALESCE(t1_INCREMENTAL_LATEST_DATE, t2_INCREMENTAL_LATEST_DATE) AS INCREMENTAL_LATEST_DATE
FROM combined
WHERE t1_ID IS NULL OR t2_ID IS NULL;


select top 10 * from CES_ERP.FSCM_PROD_FINEXTRACT_APBICCEXTRACT.INVOICE_DISTRIBUTION_EXTRACT_PVO 
where AP_INVOICE_DISTRIBUTIONS_INVOICE_ID = '300000172686093' ; 


select top 10 * from RAW_PROD.GG_CES_ERP.BICC_INVOICEDISTRIBUTIONEXTRACTPVO 
where "ApInvoiceDistributionsInvoiceId" = '300000172686093' ; 
...
SELECT 
    sum(t1_INVOICES_WITHHELD_TAX_AMOUNT), 
    sum(t2_INVOICES_WITHHELD_TAX_AMOUNT),
    sum(t1_INVOICE_AMOUNT), 
    sum(t2_INVOICE_AMOUNT),
    sum(t1_TOTAL_DISTRIBUTION_AMOUNT), 
    sum(t2_TOTAL_DISTRIBUTION_AMOUNT)

FROM combined
-- EXCLUDING 21 RECORDS NOT PRESENT DUE TO SYNC ON AUGUST 13TH 
WHERE t1_ID NOT IN 
( 
'9501-00-0000-21015-0000-00000-300000172686093-1-2',
'9506-11-1400-14920-0000-00000-300000172686093-1-3',
'9501-00-0000-21015-0000-00000-300000172686093-5-2',
'9506-11-1400-14920-0000-00000-300000172686093-1-1',
'9506-15-1400-14920-0000-00000-300000172686093-7-1',
'9501-00-0000-21015-0000-00000-300000172686093-7-2',
'9506-23-1400-14920-0000-00000-300000172686093-6-1',
'9506-41-1400-14920-0000-00000-300000172686093-2-3',
'9506-22-1400-14920-0000-00000-300000172686093-5-1',
'9506-23-1400-14920-0000-00000-300000172686093-6-3',
'9501-00-0000-21015-0000-00000-300000172686093-2-2',
'9506-41-1400-14920-0000-00000-300000172686093-2-1',
'9506-21-1400-14920-0000-00000-300000172686093-3-3',
'9506-21-1400-14920-0000-00000-300000172686093-3-1',
'9501-00-0000-21015-0000-00000-300000172686093-6-2',
'9506-22-1400-14920-0000-00000-300000172686093-5-3',
'9506-31-1400-14920-0000-00000-300000172686093-4-3',
'9506-15-1400-14920-0000-00000-300000172686093-7-3',
'9501-00-0000-21015-0000-00000-300000172686093-3-2',
'9501-00-0000-21015-0000-00000-300000172686093-4-2',
'9506-31-1400-14920-0000-00000-300000172686093-4-1'
) and 
t2_ID NOT IN 
( 
'9501-00-0000-21015-0000-00000-300000172686093-1-2',
...
SELECT  36707696734.9954 - 36707839452.5554  -->  -142,717.5600
...
WITH combined AS (
    SELECT 
        ...
        MONTH(COALESCE(t1.INVOICE_DATE,t2.INVOICE_DATE )) AS INVOICE_MONTH,
       
        CAST(t1.INVOICE_AMOUNT AS FLOAT) AS t1_INVOICE_AMOUNT,
        CAST(t2.INVOICE_AMOUNT AS FLOAT) AS t2_INVOICE_AMOUNT
...
SELECT 
    INVOICE_MONTH,
    sum(t1_INVOICE_AMOUNT) INVOICE_AMOUNT_T1, 
    sum(t2_INVOICE_AMOUNT) INVOUICE_AMOUNT_T2, 
    sum(t1_INVOICE_AMOUNT) -     sum(t2_INVOICE_AMOUNT) DIFF
...
;
SELECT     SUM(t1_QUANTITY_INVOICED),SUM(T2_QUANTITY_INVOICED), sum(INVOICE_AMOUNT_T1),sum(INVOICE_AMOUNT_T1), SUM(DIFF) FROM (  -- ID, INVOICE_AMOUNT_T1, INVOICE_AMOUNT_T2,
...
SELECT 
    ...
    sum(t1_INVOICE_AMOUNT) INVOICE_AMOUNT_T1, 
    sum(t2_INVOICE_AMOUNT) INVOUICE_AMOUNT_T2, 
    SUM( t1_QUANTITY_INVOICED) as t1_QUANTITY_INVOICED,
      SUM( T2_QUANTITY_INVOICED)AS T2_QUANTITY_INVOICED,
    sum(t1_INVOICE_AMOUNT) -     sum(t2_INVOICE_AMOUNT) DIFF
...
SELECT SUM("ApInvoicesInvoiceAmount")  FROM RAW_PROD.GG_CES_ERP.BICC_INVOICEHEADEREXTRACTPVO
WHERE MONTH("ApInvoicesInvoiceDate") = 11 AND YEAR("ApInvoicesInvoiceDate") = 2023

--102526250.15
--94373138.94
;

SELECT SUM(AP_INVOICES_INVOICE_AMOUNT) FROM CES_ERP.FSCM_PROD_FINEXTRACT_APBICCEXTRACT.INVOICE_HEADER_EXTRACT_PVO 
WHERE MONTH(AP_INVOICES_INVOICE_DATE) = 11 AND YEAR(AP_INVOICES_INVOICE_DATE) = 2023 
--- 102526250.15
----94373138.94 
;

SELECT "ApInvoicesSetOfBooksId","ApInvoicesInvoiceDate",* FROM RAW_PROD.GG_CES_ERP.BICC_INVOICEHEADEREXTRACTPVO
WHERE  "ApInvoicesInvoiceId" = '300000108296612'

--LEDGER  == 300000001410020   -- 2023-01-01
;

SELECT AP_INVOICES_SET_OF_BOOKS_ID, AP_INVOICES_INVOICE_DATE,* FROM CES_ERP.FSCM_PROD_FINEXTRACT_APBICCEXTRACT.INVOICE_HEADER_EXTRACT_PVO 
WHERE  AP_INVOICES_INVOICE_ID = '300000108296612'

--LEDGER  == 300000001410020   -- 2023-01-01 00:00:00.000 +0000

;

SELECT * FROM CES_ERP.FSCM_PROD_FINGLCALACC.FISCAL_DAY_PVO WHERE LEDGER_ID = '300000001410020'


;
SELECT * FROM RAW_PROD.GG_CES_ERP.BICC_FISCALDAYPVO WHERE "LedgerId" = '300000001410020'