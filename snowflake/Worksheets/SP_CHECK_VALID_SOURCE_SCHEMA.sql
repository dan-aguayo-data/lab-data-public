CREATE OR REPLACE PROCEDURE CES_REF.CES_DBT.VALID_SOURCE_SCHEMA("SOURCE_DATABASE" VARCHAR(16777216), "SOURCE_SCHEMA" VARCHAR(16777216), "SHARE_TYPE" VARCHAR(16777216), "SOURCE_TABLE" VARCHAR(16777216) DEFAULT null)
