...
OUTPUT_FILE = "obsolete_linked_services.txt"
...
def get_live_objects():
    try:
        ...
        print("Warning: Failed to fetch live linked service(s), assuming none exist.")
        return set()
...
if __name__ == "__main__":
    ...
    print(f"Identified {len(obsolete)} obsolete linked service(s).")
