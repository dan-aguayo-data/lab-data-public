...
FOLDER = "credential"
OUTPUT_FILE = "obsolete_credentials.txt"
...
def get_live_objects():
    try:
        result = subprocess.run(
            [
                "az", "datafactory", "credential", "list",
        ...
        print("Warning: Failed to fetch live credential(s), assuming none exist.")
        return set()
...
if __name__ == "__main__":
    ...
    print(f"Identified {len(obsolete)} obsolete credential(s).")
